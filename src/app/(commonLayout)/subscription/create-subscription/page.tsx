...
import { useCreateSubscriptionMutation } from '@/redux/features/subscription/subcApi';
import toast from 'react-hot-toast';

const SubscriptionForm = () => {
    const [form] = Form.useForm();
    const [creatingSubscription] = useCreateSubscriptionMutation()

    const handleSubmit = () => {
        form.validateFields().then(async (values) => {
            try {
                const created = await creatingSubscription(values).unwrap()
